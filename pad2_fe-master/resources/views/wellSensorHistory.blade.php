                ...
                <div class="row">
                    <div class="col-md-2 d-flex">
                        <div class="col-auto p-2">
                            <div class="dropdown">
                                <select class="form-select" aria-label="Select Sensor" id="sensorDates">
                                    @if ($sensorDates->isNotEmpty())
                                            <option value="Select the history date" selected>
                                                Select the history date
                                            </option>
                                        @foreach ($sensorDates as $date)
                                            <option value="{{ $date }}">
                                                {{ $date }}
                                            </option>
                                        @endforeach
